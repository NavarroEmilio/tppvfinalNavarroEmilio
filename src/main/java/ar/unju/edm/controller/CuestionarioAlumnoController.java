...
import ar.unju.edm.service.ICuestionarioService;
...
public class CuestionarioAlumnoController {
	...
	public ModelAndView guardarCuesEstudiante () {
		...
		listadoCuestionarioAlumno.addObject("cuesEstudianteListado", cuestionarioAlumnoService.listarTodosCuestionariosAlumnos() );
